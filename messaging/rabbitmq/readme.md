...
# install plugins
docker exec -ti rabbit-manager bash

rabbitmq-plugins list
apt-get update &&  apt-get install -y wget 
rabbitmq-plugins directories
wget -O /opt/rabbitmq/plugins/rabbitmq_delayed_message_exchange-3.12.0.ez   https://github.com/rabbitmq/rabbitmq-delayed-message-exchange/releases/download/3.12.0/rabbitmq_delayed_message_exchange-3.12.0.ez
...
参考资料 [rabbitmq详解](https://developer.aliyun.com/article/1174453)
